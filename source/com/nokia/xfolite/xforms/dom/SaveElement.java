...
public class SaveElement extends ActionElement {

	SaveElement(Document ownerDocument, String aNamespaceURI, String aPrefix, String aLocalName) {
    ...
    public void handleEvent(DOMEvent evt) {
        ...
        ((XFormsDocument)ownerDocument).save(src, refNode, name);
    }
