...
public class StopElement extends StartElement{

	StopElement(Document ownerDocument, String aNamespaceURI, String aPrefix, String aLocalName) {
    ...
    public void doHandleEvent(DOMEvent evt, ActionElement outermost) {
    	...
    	if (timer!=null)
    		timer.dispatchEvent(DOMEvent.XFORMS_TIMER_STOP);
    }
