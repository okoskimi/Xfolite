...
public class DataTypeBoolean extends DataTypeBase {
    ...
    public DataTypeBoolean() {
        super(DataTypeBase.XML_SCHEMAS_BOOLEAN);
    }
    ...
    public void setBooleanValue(boolean value, ValueProvider prov) {
        if (value) {
            prov.setStringValue("true");
        } else {
            prov.setStringValue("false");
        }
    }
    
    public boolean getBooleanValue(ValueProvider prov) {
        boolean ret = false;
        String strVal = prov.getStringValue();
