...
public interface ISubmitter {
    boolean canHandle(SubmissionElement submission);
    void startSubmission(SubmissionElement submission, ISerializer serializer, Element root, XFormsModel model);
    boolean isOngoing();
    ISubmitter cloneSubmitter();
}
