...
public class XF_Button extends StringItem {

    public XF_Button(String label, String text) {
        super(label, text, BUTTON);
    }

    public XF_Button(String label, String text, Style style) {
        super(label, text, BUTTON, style);
    }
