...
public class XF_Range extends Range {

    public XF_Range(double start, double end, double step,
            double value, int type) {
        super(null, start, end, step, value, type);
        // TODO Auto-generated constructor stub
    }

    public XF_Range(double start, double end, double step,
            double value, int type, Style style) {
        super(null, start, end, step, value, type, style);
        // TODO Auto-generated constructor stub
    }
